      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'div',
            { style: this.scrollbarContentStyle(), onScroll: this.handleScroll },
          ...
          _react2['default'].createElement(_sticks2['default'], _extends({}, this.props, this.getScrollbarProps()))
        );
      }
    }]);
