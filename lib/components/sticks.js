  ...
  verticalScrollbar: function verticalScrollbar(style, stickStyle) {
    if (this.props.vertical && this.props.showScrollbar.vertical) {
      return _react2['default'].createElement(
        'div',
        { className: 'rs-bar', style: style },
        _react2['default'].createElement('div', { className: 'rs-stick', style: stickStyle, onMouseDown: this.props.onMouseDown.bind(null, 'y') })
      );
    } else {
      return null;
    }
